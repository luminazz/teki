...
source.getResource = function (movieInfo, config, callback) { return __awaiter(_this, void 0, void 0, function () {
    var PROVIDER, DOMAIN, urlSearch, parseSearch, id, urlDetail, headers, body, parseDetail, filemoon, htmlTest, text, requestData, redirectUrl, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4, libs.request_post(urlDetail, headers, body, true)];
            case 3:
                parseDetail = _a.sent();
            ...
            case 4:
                htmlTest = _a.sent();
                return [4, htmlTest.text()];
            case 5:
                text = _a.sent();
                libs.log({ text: text }, PROVIDER, 'TEXT');
                return [4, fetch(filemoon, {
                        redirect: 'manual',
                        method: 'HEAD',
                        headers: {
            ...
            case 6:
                ...
                libs.log({ redirectUrl: redirectUrl }, PROVIDER, 'REQUEST DATA');
                if (!redirectUrl) {
                    return [2];
                }
                return [4, libs.embed_redirect(redirectUrl, '', movieInfo, PROVIDER, callback, '')];
            case 7:
                _a.sent();
                return [3, 9];
            case 8:
