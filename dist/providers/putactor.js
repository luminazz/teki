    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                LINK_DETAIL_1 = '';
                libs.log({ length: parseSearch_1('._VPzQdLFXWQppjNou').length }, PROVIDER, 'SEARCH LENGTH');
                parseSearch_1('._VPzQdLFXWQppjNou').each(function (key, item) {
            ...
            case 3:
                ...
                libs.log({ length: parseTvDetail_1('._IjnOCpWcILEBigFX a').length }, PROVIDER, 'EPISODE LENGTH');
                parseTvDetail_1('._IjnOCpWcILEBigFX a').each(function (key, item) {
            ...
            case 8:
                ...
                libs.log({ length: parseServer_1('._buDEuRMqEeKEvsbH').length }, PROVIDER, 'SERVER LENGTH');
                parseServer_1('._buDEuRMqEeKEvsbH').each(function (key, item) {
